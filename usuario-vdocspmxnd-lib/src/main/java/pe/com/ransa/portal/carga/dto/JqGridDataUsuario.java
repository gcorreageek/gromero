...
public class JqGridDataUsuario implements Serializable{
	private static final long serialVersionUID = 1L;
	
	private int page;
	private int total;
	private int records;
	private List<UsuarioDTO> rows;
	...
	public List<UsuarioDTO> getRows() {
		return rows;
	}
	public void setRows(List<UsuarioDTO> rows) {
		this.rows = rows;
	}
